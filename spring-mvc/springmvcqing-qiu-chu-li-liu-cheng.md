...
上文我们讲完了[Hadnler ](#Handler)[HandlerIntercptor](#Handler)和 [HandlerExcutionChain](#HandlerExecutionChain), HandlerAdapter会根据HandlerMapping找到支持这种mapping规则的HandlerAdapter，然后调用handle方法执行用户定义的请求处理方法。
